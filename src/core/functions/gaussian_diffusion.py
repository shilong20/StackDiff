...
class GaussianDiffusion:
    ...
    def p_sample_loop_progressive(
        ...
        model_kwargs['Ap'] = Ap
        # gt=256*1024
        y_temp = A_temp(gt) # 64*256
        Apy_temp = Ap(y_temp) # 256*1024

        H_target, W_target = Apy_temp.shape[2], Apy_temp.shape[3]
        model_kwargs['H_target'] = H_target # 256
        model_kwargs['W_target'] = W_target # 1024
        ...
        shift_h_total = math.ceil(H_target/128)-1 # 1
        shift_w_total = math.ceil(W_target/128)-1 # 7
