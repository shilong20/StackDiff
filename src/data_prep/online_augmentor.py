# -*- coding: utf-8 -*-
"""
Purpose: Image augmentation utilities for StackDiff training. The functions apply geometric transforms, carbon-like background, cropping, flips, scan/Poisson/Gaussian noise, and display normalization.
Related files: configs/train/*.yml and src/core/datasets/online_augment_dataset.py.
CLI usage: This module is imported by training datasets and is not intended to be executed directly.
"""
