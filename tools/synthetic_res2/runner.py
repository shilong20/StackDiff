"""
Purpose: Backend for the optional ReS2 synthetic STEM generator. It builds bilayer structures, calls the external incostem executable, applies augmentations, and writes 128 x 128 PNG images plus optional labels.
Related files: tools/synthetic_res2/generate.py, tools/synthetic_res2/config.json, tools/synthetic_res2/structures/ReS2.xyz, tools/synthetic_res2/masks/ReS2.png, and tools/synthetic_res2/augment.py.
CLI usage: Use python tools/synthetic_res2/generate.py --config tools/synthetic_res2/config.json.
"""
...
def load_config(path: Path) -> BatchConfig:
    ...
    return BatchConfig(
        ...
        mask_path=_as_path(ROOT_DIR, str(data.get("mask_path", "tools/synthetic_res2/masks/ReS2.png"))),
        augment=augment,
        x_range=RangeSpec(
