# -*- coding: utf-8 -*-
"""
Purpose: Image augmentation utilities for the optional ReS2 synthetic STEM generator. The functions apply geometric transforms, carbon-like background, cropping, flips, scan/Poisson/Gaussian noise, and display normalization.
Related files: tools/synthetic_res2/runner.py, tools/synthetic_res2/generate.py, and tools/synthetic_res2/config.json.
CLI usage: This module is imported by tools/synthetic_res2/runner.py and is not intended to be executed directly.
"""
